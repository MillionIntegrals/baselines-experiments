...
#gcloud compute instances create rl-worker-0031 --source-instance-template rl-04cpu --zone=europe-west1-b --labels experiment=beamrider_trpo_oai,algo=trpo_oai
#gcloud compute instances create rl-worker-0032 --source-instance-template rl-04cpu --zone=europe-west1-b --labels experiment=enduro_trpo_oai,algo=trpo_oai
